force TFAR_setting_DefaultRadio_Rifleman_West = "TFAR_anprc154";
...
force TFAR_setting_DefaultRadio_Personal_West = "TFAR_anprc154";
...
force TFAR_setting_DefaultRadio_Airborne_West = "TFAR_anprc154";
